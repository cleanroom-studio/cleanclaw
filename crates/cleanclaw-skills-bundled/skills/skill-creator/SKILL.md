...
## CleanClaw runtime — read this first

This skill is invoked from a CleanClaw agent. The host runtime has its
...
disk (`~/.cleanclaw/users/<userId>/skills/<name>/`). SkillsLoader scans
...
etc. On CleanClaw, ignore those file-layout details: the only thing
