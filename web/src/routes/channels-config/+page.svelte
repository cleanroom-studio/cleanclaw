  ...
  async function save() {
    ...
    try {
      await saveChannelConfig({
        ...
        line: { channel_secret: lineChannelSecret, channel_token: lineChannelToken },
        wechat: { app_id: wechatAppId, app_secret: wechatAppSecret, token: wechatToken }
      });
      message = 'saved';
...
<div class="p-6 max-w-4xl mx-auto space-y-4">
  <div>
    ...
    <p class="text-sm text-zinc-400 mt-1">Platform-level defaults. Per-agent bindings (bot token etc.) are still managed on the agent's own Channels page.</p>
  </div>
  ...
  <Card>
    ...
    <div class="grid grid-cols-2 gap-3">
      <div>
        ...
        <Input id="tg-url" bind:value={telegramUrl} placeholder="https://gateway/..." />
      </div>
      <div>
  ...
  <Card>
    ...
    <div class="grid grid-cols-2 gap-3">
      <div><Label for="dc-pk">Public key</Label><Input id="dc-pk" bind:value={discordPublicKey} /></div>
      <div><Label for="dc-tk">Bot token</Label><Input id="dc-tk" type="password" bind:value={discordBotToken} /></div>
    </div>
  </Card>
  ...
  <Card>
    ...
    <div class="grid grid-cols-2 gap-3">
      <div><Label for="sk-ss">Signing secret</Label><Input id="sk-ss" type="password" bind:value={slackSigningSecret} /></div>
      <div><Label for="sk-tk">Bot token</Label><Input id="sk-tk" type="password" bind:value={slackBotToken} /></div>
    </div>
  </Card>
  ...
  <Card>
    ...
    <div class="grid grid-cols-2 gap-3">
      <div><Label for="fs-id">App ID</Label><Input id="fs-id" bind:value={feishuAppId} /></div>
      <div><Label for="fs-ss">App secret</Label><Input id="fs-ss" type="password" bind:value={feishuAppSecret} /></div>
    </div>
  </Card>
  ...
  <Card>
    ...
    <div class="grid grid-cols-2 gap-3">
      <div><Label for="ln-cs">Channel secret</Label><Input id="ln-cs" type="password" bind:value={lineChannelSecret} /></div>
      <div><Label for="ln-ct">Channel access token</Label><Input id="ln-ct" type="password" bind:value={lineChannelToken} /></div>
    </div>
  </Card>
  ...
  <Card>
    ...
    <div class="grid grid-cols-2 gap-3">
      <div><Label for="wc-id">App ID</Label><Input id="wc-id" bind:value={wechatAppId} /></div>
      <div><Label for="wc-as">App secret</Label><Input id="wc-as" type="password" bind:value={wechatAppSecret} /></div>
      <div class="col-span-2"><Label for="wc-tk">Token (URL validation)</Label><Input id="wc-tk" type="password" bind:value={wechatToken} /></div>
    </div>
  </Card>
